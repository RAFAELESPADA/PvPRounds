...
/* 106 */         sender.sendMessage(ChatColor.DARK_AQUA + "§m-----------" + ChatColor.AQUA + " PVPROUNDS COMMANDS " + ChatColor.DARK_AQUA + ChatColor.STRIKETHROUGH + "-------------");
...
/*     */           {
/* 173 */sender.sendMessage("You are already on the PvPRound!");            
	return true;
/*     */           }
...
/*     */       {
	...
	/* 297 */       game.remove(p.getName());
                    p.sendMessage(ChatColor.RED + "You left the PvPRound");
