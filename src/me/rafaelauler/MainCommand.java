...
/* 106 */         sender.sendMessage(ChatColor.DARK_AQUA + "§m-----------" + ChatColor.AQUA + " PVPROUNDS ROOM 1 COMMANDS " + ChatColor.DARK_AQUA + ChatColor.STRIKETHROUGH + "-------------");
...
/*     */           {
/* 173 */sender.sendMessage("You are already on the PvPRound room 1!");            
	return true;
/*     */           }
